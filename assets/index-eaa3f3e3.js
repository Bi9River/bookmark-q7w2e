...
<div id="controls-content">
  ...
  try {
    ...
    const url = `https://raw.githubusercontent.com/Bi9River/prvbkmkjson/refs/heads/master/bookmarks.json?t=${timestamp}`;
    ...
    c = (await e.json()).categories;
    console.log("书签数据加载成功:", c.length, "个分类");
    return c;
  } catch (e) {
...
}function Q(){return[{title:"🤖 AI Assistants",links:[{name:"ChatGPT",url:"https://chat.openai.com"},{name:"Claude",url:"https://claude.ai"}]}]}function U(){return!c||c.length===0?'<div style="text-align: center; color: var(--text-color); padding: 2rem;">正在加载书签...</div>':c.map(e=>`
